...
import BetAutoSwitch from '../aviator/BetAutoSwitch'
...
import BetBoard from '../aviator/BetBoard'
import CustomSnackBar from '../CustomSnackBar';

const AviatorGame = ({ bet6 = ["20", "50", "100", "500"] }: { bet6?: string[] }) => {
    const { aviatorState, setAviatorState } = useAviator()
    const [autoPlayingIndex, setAutoPlayingIndex] = useState(0)
    const [snackState, setSnackState] = useState({ open: false, msg: "" });
